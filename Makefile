...
pineapple: apigen internalapigen billing_client_codegen
...
billing: billing_oapi_codegen billing_client_codegen
	cd src && $(GO) build $(BUILDARGS) -o ../$(OUTPUT_DIR)/billing ./billing

webhook: billing_client_codegen
